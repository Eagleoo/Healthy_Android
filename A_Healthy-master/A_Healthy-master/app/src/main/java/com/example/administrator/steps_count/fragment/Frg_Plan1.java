...
public class Frg_Plan1 extends Fragment {
    private ListView eat_listView;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        eat_listView=(ListView)view.findViewById(R.id.eat_listView);
        list=new ArrayList<Plan_Btn>();
        LoadData();
        adapter = new Plan_Adapter(list,getActivity());
        eat_listView.setAdapter(adapter);
                        ...
                        new Runnable() {
                            ...
                            public void run() {
                                ...
                                for (int i=0;i<PlanList.size();i++){
                                    if( PlanList.get(i).getP_type().equals("饮食")){
