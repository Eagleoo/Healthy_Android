...
public class Frg_Plan2 extends Fragment {
                        ...
                        new Runnable() {
                            ...
                            public void run() {
                                ...
                                for (int i=0;i<PlanList.size();i++){
                                    if( PlanList.get(i).getP_type().equals("运动")){
