...
public class Frg_Plan3 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.frg_3, container, false);
        drink_listView=(ListView)view.findViewById(R.id.drink_listView);
        adapter = new Plan_Adapter(list,getActivity());
        drink_listView.setAdapter(adapter);
                        ...
                        new Runnable() {
                            ...
                            public void run() {
                                ...
                                for (int i=0;i<PlanList.size();i++){
                                    if( PlanList.get(i).getP_type().equals("喝水")){
