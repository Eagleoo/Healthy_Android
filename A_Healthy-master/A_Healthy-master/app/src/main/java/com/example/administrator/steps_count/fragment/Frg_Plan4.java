...
public class Frg_Plan4 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.frg_4 ,container, false);
        sleep_listView=(ListView)view.findViewById(R.id.sleep_listView);
        adapter = new Plan_Adapter(list,getActivity());
        sleep_listView.setAdapter(adapter);
                        ...
                        new Runnable() {
                            ...
                            public void run() {
                                ...
                                for (int i=0;i<PlanList.size();i++){
                                    if( PlanList.get(i).getP_type().equals("睡眠")){
