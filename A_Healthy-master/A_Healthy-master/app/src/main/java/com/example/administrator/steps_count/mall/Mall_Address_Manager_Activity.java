...
public class Mall_Address_Manager_Activity extends AppCompatActivity implements Address_adapter.Address_function {
        ...
        new_address.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        startActivity(new Intent(Mall_Address_Manager_Activity.this,Addaddress_Acitvity.class));
                    }
                }
        );
    ...
    private void getAddr() {
        ...
        RequestBody requestBody = new FormBody.Builder()
                .add("username", Frag_MainActivity.user.getUser_phone()).build();
                ...
                if (response.isSuccessful()) {
                    ...
                    runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            address_adapter.setAddress_function(Mall_Address_Manager_Activity.this);
                        }
                    });
                }
            }
